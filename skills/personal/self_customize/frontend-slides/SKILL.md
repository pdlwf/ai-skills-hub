...
description: Create distinctive HTML presentations from scratch or by converting PPT/PPTX decks, with strong visual direction, layout, and motion.
origin: ECC
---
...
This is a `self_customize` skill. Maintain it only from the canonical folder `skills/personal/self_customize/frontend-slides` in the `ai-skills-hub` repo through Codex or Claude Code.
