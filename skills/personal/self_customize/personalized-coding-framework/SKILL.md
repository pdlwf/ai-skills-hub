...
description: Apply and evolve Bobby's coding preferences across planning, architecture, implementation, debugging, testing, reviews, and technical writing.
---
...
This is a `self_customize` skill. Maintain it only from the canonical folder `skills/personal/self_customize/personalized-coding-framework` in the `ai-skills-hub` repo through Codex or Claude Code.
